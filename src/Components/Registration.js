                                    ...
                                    <div className='name-box  flex gap-2 my-5'>
                                        <div className='name_title  '>
                                            ...
                                            <div id='name-saluation' className='name-title pr-1  ' >
                                                <select className=' saluation pl-2 border rounded mr-1 w-full' id="saluation" name="title" >
                                        ...
                                        <div className='name flex flex-col flex-1 '>
                                            <label >Name</label>
                                            <input id="name" className='name-input flex-1 w-full ' type='text' placeholder='Enter Full Name' />
                                        </div>
                                    </div>
                                    <div className='company-email mb-5  flex flex-col'>
                                        <label >Company Email ID</label>
                                        <input className='company-input' type='text' placeholder='Enter Company Email ID' />
                                    </div>
